...
- `socal` (SoCal) is a senior social media strategist and content developer. It asks clarifying questions first, researches the client in Google Drive and on the web, works from the playbook in `docs/socal/playbook.md`, and delivers consulting-grade strategy decks and content calendars. Claude delegates to it automatically for any social media request.
